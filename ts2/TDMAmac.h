...
// ToDo: double check do we need re-define a new packet class
// class MyMacPkt; // My Mac packet definition !aaks look at MyMacPkt.msg
...
class MIXIM_API TDMAmac : public BaseMacLayer
{
    ...
    private:
        // Copy constructor is not allowed. #LMAC
        TDMAmac(const TDMAmac&);

        // Assignment operator is not allowed. #LMAC
...
protected:
    ...
    typedef std::list<MacPkt*> MacPktQueue;
