...
/*void Clock::adjtimex(double value[2]){
	ev << "---------------------------------" << endl;
			ev << "CLOCK : AGGIORNAMENTO OFFSET" << endl;
			ev << "CLOCK : offset- = " << offset<<endl;
			ev<<"simTime="<<SIMTIME_DBL(simTime())<<" lastupdatetime="<<lastupdatetime<<endl;
